...
include 'backend/laporan/iuran/t_laporaniuran.php';
?>
...
<body data-bvite="theme-CeruleanBlue" class="layout-border svgstroke-a layout-default rightbar-hide">
	...
	<main class="container-fluid px-0">
		...
		<div class="px-md-4 px-2 py-2 page-header" data-bs-theme="light">
			...
			<div class="d-flex align-items-center">
				...
				<ol class="breadcrumb mb-0 bg-transparent">
					...
					<li class="breadcrumb-item" aria-current="page" title="laporan">Laporan</li>
					<li class="breadcrumb-item active" aria-current="page" title="iuran santri">Iuran Santri</li>
				</ol>
			</div>
		...
		<div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
			<?php include 'content/laporan/iuran/c_laporaniuran.php'; ?>
		</div>
	...
	<script type="text/javascript" src="js/laporan/iuran/laporaniuran.js"></script>
</body>
</html>
