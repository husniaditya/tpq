...
<body data-bvite="theme-CeruleanBlue" class="layout-border svgstroke-a layout-default rightbar-hide">
	...
	<main class="container-fluid px-0">
		...
		<div class="px-md-4 px-2 py-2 page-header" data-bs-theme="none">
			...
			<div class="d-flex align-items-center">
				...
				<ol class="breadcrumb mb-0 bg-transparent">
					...
					<li class="breadcrumb-item active" aria-current="page" title="ubah data pendaftaran">Ubah Data Santri</li>
				</ol>
			</div>
		...
		<div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
			<?php include 'content/transaksi/pendaftaran/c_pendaftaran_edit.php'; ?>
		</div>
