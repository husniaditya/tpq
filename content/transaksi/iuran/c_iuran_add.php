...
<div class="card mb-4">
    <div class="card-header py-3 bg-transparent border-bottom-0">
        <h4 class="card-title mb-0"><strong>Tambah Iuran Santri</strong></h4>
    </div>
        ...
        <form role="form" action="" method="post">
                    ...
                    <fieldset class="form-icon-group left-icon position-relative"> 
                        <select class="form-select array-select form-control" aria-label="example" name="ID_ANGGOTA" required>
                            ...
                            foreach ($rowAnggota as $dataAnggota) {
                                extract($dataAnggota);
                                ?>
                                <option value="<?= $ID_ANGGOTA; ?>"><?= $ID_ANGGOTA; ?> - <?= $NAMA_ANGGOTA; ?></option>
                                <?php
                            }
                            ?>
                        </select>
            ...
            <div class="row">
                <div class="mb-1 col-md-3 col-12">
                    ...
                    <fieldset class="form-icon-group left-icon position-relative">
                        <input type="text" name="TGL_IURAN" class="form-control f-basic flatpickr-input" placeholder="Pilih Tanggal.." value="" required>
                    </fieldset>
                </div>
