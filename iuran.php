...
include 'backend/transaksi/iuran/t_iuran.php';
?>
...
<body data-bvite="theme-CeruleanBlue" class="layout-border svgstroke-a layout-default rightbar-hide">
	...
	<main class="container-fluid px-0">
		...
		<div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
			<?php include 'content/transaksi/iuran/c_iuran.php'; ?>
		</div>
	...
	<script type="text/javascript" src="js/transaksi/iuran/iuran.js"></script>
</body>
</html>
